...
public class ParticleRenderer {
	...
	protected ParticleRenderer(Loader loader, Matrix4f projectionMatrix){
		...
		loader.addInstancedAttribute(quad.getVaoID(), vbo, 3, 4, INSTANCE_DATA_LENGTH, 5);
	...
	private void bindTexture(ParticleTexture texture) {
		if(texture.isAdditive()==true) GL11.glBlendFunc(GL11.GL_SRC_ALPHA, GL11.GL_ONE);
	...
	private void prepare(){
		...
		GL11.glDepthMask(false); // stops particle from being rendered to depth buffer
	}

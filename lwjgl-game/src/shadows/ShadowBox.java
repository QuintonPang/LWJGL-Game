...
public class ShadowBox {
	...
	private static final float OFFSET = 15; // high to prevent some shadows behind the camera from being cut off, if too high it lowers resolution of shadows
	private static final Vector4f UP = new Vector4f(0, 1, 0, 0);
	private static final Vector4f FORWARD = new Vector4f(0, 0, -1, 0);
	private static final float SHADOW_DISTANCE = 150; // distance in which objects within it have their shadows rendered

package geometryShaders;

import org.lwjgl.util.vector.Matrix4f;

public class StaticShader extends ShaderProgram{
	
	private static final String VERTEX_FILE = "src/geometryShaders/vertexShader.txt";
	private static final String GEOMETRY_FILE = "src/geometryShaders/geometryShader.txt";
	private static final String FRAGMENT_FILE = "src/geometryShaders/fragmentShader.txt";
